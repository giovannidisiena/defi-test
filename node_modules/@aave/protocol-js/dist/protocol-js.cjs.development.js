...
var cosntantAddressesByNetwork = (_cosntantAddressesByN = {}, _cosntantAddressesByN[exports.Network.mainnet] = {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(LENDING_POOL) || !FLASH_LIQUIDATION_ADAPTER || !ethers.utils.isAddress(FLASH_LIQUIDATION_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(LENDING_POOL) || !REPAY_WITH_COLLATERAL_ADAPTER || !ethers.utils.isAddress(REPAY_WITH_COLLATERAL_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(LENDING_POOL) || !SWAP_COLLATERAL_ADAPTER || !ethers.utils.isAddress(SWAP_COLLATERAL_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(LENDING_POOL)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(LEND_TO_AAVE_MIGRATOR)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(INCENTIVES_CONTROLLER_REWARD_TOKEN) || !ethers.utils.isAddress(INCENTIVES_CONTROLLER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(SWAP_COLLATERAL_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(REPAY_WITH_COLLATERAL_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(TOKEN_STAKING) || !ethers.utils.isAddress(STAKING_REWARD_TOKEN)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(TOKEN_STAKING) || !ethers.utils.isAddress(STAKING_REWARD_TOKEN) || !STAKING_HELPER || !ethers.utils.isAddress(TOKEN_STAKING)) {
      console.error("[StakingValidator] You need to pass valid addresses");
      return [];
    }
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!FAUCET || FAUCET && !ethers.utils.isAddress(FAUCET)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(WETH_GATEWAY)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    if (!ethers.utils.isAddress(AAVE_GOVERNANCE_V2) || !ethers.utils.isAddress(AAVE_GOVERNANCE_V2_HELPER) || !ethers.utils.isAddress(AAVE_GOVERNANCE_V2_EXECUTOR_SHORT) || !ethers.utils.isAddress(AAVE_GOVERNANCE_V2_EXECUTOR_LONG)) {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 5:
              ...
              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, this.swapCollateralAddress, ethers.constants.MaxUint256.toString());
                txs.push(approveTx);
              }
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 5:
              ...
              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, this.repayWithCollateralAddress, ethers.constants.MaxUint256.toString());
                txs.push(approveTx);
              }
...
tslib.__decorate([SignStakingValidator, tslib.__param(0, IsEthAddress()), tslib.__param(1, IsPositiveAmount()), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [String, String, String]), tslib.__metadata("design:returntype", Promise)], StakingService.prototype, "signStaking", null);
...
var BaseTxBuilder = function BaseTxBuilder(network, injectedProvider, defaultProviderKeys, config) {
  ...
  } else if (injectedProvider instanceof ethers.providers.Provider) {
...
exports.cosntantAddressesByNetwork = cosntantAddressesByNetwork;
