...
function calculateHealthFactorFromBalancesBigUnits(collateralBalanceETH, borrowBalanceETH, currentLiquidationThreshold) {
  return calculateHealthFactorFromBalances(collateralBalanceETH, borrowBalanceETH, new BigNumber(currentLiquidationThreshold).multipliedBy(pow10(LTV_PRECISION)).decimalPlaces(0, BigNumber.ROUND_DOWN));
}
...
function calculateHealthFactorFromBalancesBigUnits$1(collateralBalanceETH, borrowBalanceETH, totalFeesETH, currentLiquidationThreshold) {
  return calculateHealthFactorFromBalances$1(collateralBalanceETH, borrowBalanceETH, totalFeesETH, new BigNumber(currentLiquidationThreshold).multipliedBy(100).decimalPlaces(0, BigNumber.ROUND_DOWN));
}
...
(function (Network) {
  ...
  Network["avalanche_fork"] = "avalanche_fork";
  Network["fuji"] = "fuji";
  Network["arbitrum_one"] = "arbitrum_one";
  Network["arbitrum_rinkeby"] = "arbitrum_rinkeby";
})(Network || (Network = {}));
...
(function (ChainId) {
  ...
  ChainId[ChainId["avalanche_fork"] = 1337] = "avalanche_fork";
...
var _gasLimitRecommendati, _cosntantAddressesByN;
var DEFAULT_NULL_VALUE_ON_TX =
/*#__PURE__*/
BigNumber$1.from(0).toHexString();
...
var SURPLUS = '0.05';
var gasLimitRecommendations = (_gasLimitRecommendati = {}, _gasLimitRecommendati[ProtocolAction["default"]] = {
  limit: '210000',
  recommended: '210000'
}, _gasLimitRecommendati[ProtocolAction.deposit] = {
  limit: '300000',
  recommended: '300000'
}, _gasLimitRecommendati[ProtocolAction.withdraw] = {
  limit: '230000',
  recommended: '300000'
}, _gasLimitRecommendati[ProtocolAction.liquidationCall] = {
  limit: '700000',
  recommended: '700000'
}, _gasLimitRecommendati[ProtocolAction.liquidationFlash] = {
  limit: '995000',
  recommended: '995000'
}, _gasLimitRecommendati[ProtocolAction.repay] = {
  limit: '300000',
  recommended: '300000'
}, _gasLimitRecommendati[ProtocolAction.borrowETH] = {
  limit: '450000',
  recommended: '450000'
}, _gasLimitRecommendati[ProtocolAction.withdrawETH] = {
  limit: '640000',
  recommended: '640000'
}, _gasLimitRecommendati[ProtocolAction.swapCollateral] = {
  limit: '1000000',
  recommended: '1000000'
}, _gasLimitRecommendati[ProtocolAction.repayCollateral] = {
  limit: '700000',
  recommended: '700000'
}, _gasLimitRecommendati);
var cosntantAddressesByNetwork = (_cosntantAddressesByN = {}, _cosntantAddressesByN[Network.mainnet] = {
  SYNTHETIX_PROXY_ADDRESS: '0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f'
}, _cosntantAddressesByN);
...
var parseNumber = function parseNumber(value, decimals) {
  return new BigNumber(value).multipliedBy(new BigNumber(10).pow(decimals)).toFixed(0);
};
  ...
  if (addressParameters) {
    addressParameters.forEach(function (storedParams) {
      if (storedParams.field) {
        if (methodArguments[0][storedParams.field] && !utils.isAddress(methodArguments[0][storedParams.field])) {
        ...
        if (methodArguments[storedParams.index] && !isOptional && !utils.isAddress(methodArguments[storedParams.index])) {
...
/* eslint-disable prefer-rest-params */
function LPFlashLiquidationValidator( // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
target, propertyName, descriptor) {
  var method = descriptor.value; // eslint-disable-next-line no-param-reassign

  descriptor.value = function () {
    var _ref = this.lendingPoolConfig || {},
        LENDING_POOL = _ref.LENDING_POOL,
        FLASH_LIQUIDATION_ADAPTER = _ref.FLASH_LIQUIDATION_ADAPTER;

    if (!utils.isAddress(LENDING_POOL) || !FLASH_LIQUIDATION_ADAPTER || !utils.isAddress(FLASH_LIQUIDATION_ADAPTER)) {
...
function LPRepayWithCollateralValidator( // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
target, propertyName, descriptor) {
  var method = descriptor.value; // eslint-disable-next-line no-param-reassign

  descriptor.value = function () {
    var _ref2 = this.lendingPoolConfig || {},
        LENDING_POOL = _ref2.LENDING_POOL,
        REPAY_WITH_COLLATERAL_ADAPTER = _ref2.REPAY_WITH_COLLATERAL_ADAPTER;

    if (!utils.isAddress(LENDING_POOL) || !REPAY_WITH_COLLATERAL_ADAPTER || !utils.isAddress(REPAY_WITH_COLLATERAL_ADAPTER)) {
...
function LPSwapCollateralValidator( // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
target, propertyName, descriptor) {
  var method = descriptor.value; // eslint-disable-next-line no-param-reassign

  descriptor.value = function () {
    var _ref3 = this.lendingPoolConfig || {},
        LENDING_POOL = _ref3.LENDING_POOL,
        SWAP_COLLATERAL_ADAPTER = _ref3.SWAP_COLLATERAL_ADAPTER;

    if (!utils.isAddress(LENDING_POOL) || !SWAP_COLLATERAL_ADAPTER || !utils.isAddress(SWAP_COLLATERAL_ADAPTER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _ref4 = this.lendingPoolConfig || {},
        LENDING_POOL = _ref4.LENDING_POOL;
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _this$migratorConfig;

    var LEND_TO_AAVE_MIGRATOR = ((_this$migratorConfig = this.migratorConfig) == null ? void 0 : _this$migratorConfig.LEND_TO_AAVE_MIGRATOR) || '';
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _ref5 = this.incentivesConfig || {},
        INCENTIVES_CONTROLLER = _ref5.INCENTIVES_CONTROLLER,
        INCENTIVES_CONTROLLER_REWARD_TOKEN = _ref5.INCENTIVES_CONTROLLER_REWARD_TOKEN;

    if (!utils.isAddress(INCENTIVES_CONTROLLER_REWARD_TOKEN) || !utils.isAddress(INCENTIVES_CONTROLLER)) {
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var SWAP_COLLATERAL_ADAPTER = this.swapCollateralConfig.SWAP_COLLATERAL_ADAPTER || '';
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _this$repayWithCollat;

    var REPAY_WITH_COLLATERAL_ADAPTER = ((_this$repayWithCollat = this.repayWithCollateralConfig) == null ? void 0 : _this$repayWithCollat.REPAY_WITH_COLLATERAL_ADAPTER) || '';
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    ...
    var _ref6 = this.stakingConfig || {},
        TOKEN_STAKING = _ref6.TOKEN_STAKING,
        STAKING_REWARD_TOKEN = _ref6.STAKING_REWARD_TOKEN; // Check if addresses are valid.


    if (!utils.isAddress(TOKEN_STAKING) || !utils.isAddress(STAKING_REWARD_TOKEN)) {
...
function SignStakingValidator( // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
target, propertyName, descriptor) {
  var method = descriptor.value; // eslint-disable-next-line no-param-reassign
  ...
  descriptor.value = function () {
    // No need to check if addresses exist for network
    // because this is checked at initialization and type checking of config
    var _ref7 = this.stakingConfig || {},
        TOKEN_STAKING = _ref7.TOKEN_STAKING,
        STAKING_REWARD_TOKEN = _ref7.STAKING_REWARD_TOKEN,
        STAKING_HELPER = _ref7.STAKING_HELPER; // Check if addresses are valid.


    if (!utils.isAddress(TOKEN_STAKING) || !utils.isAddress(STAKING_REWARD_TOKEN) || !STAKING_HELPER || !utils.isAddress(TOKEN_STAKING)) {
      console.error("[StakingValidator] You need to pass valid addresses");
      return [];
    }
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _this$faucetConfig;

    var FAUCET = (_this$faucetConfig = this.faucetConfig) == null ? void 0 : _this$faucetConfig.FAUCET;
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _this$wethGatewayConf;

    var WETH_GATEWAY = ((_this$wethGatewayConf = this.wethGatewayConfig) == null ? void 0 : _this$wethGatewayConf.WETH_GATEWAY) || '';
...
target, propertyName, descriptor) {
  ...
  descriptor.value = function () {
    var _ref8 = this.governanceConfig || {},
        AAVE_GOVERNANCE_V2 = _ref8.AAVE_GOVERNANCE_V2,
        AAVE_GOVERNANCE_V2_HELPER = _ref8.AAVE_GOVERNANCE_V2_HELPER,
        AAVE_GOVERNANCE_V2_EXECUTOR_SHORT = _ref8.AAVE_GOVERNANCE_V2_EXECUTOR_SHORT,
        AAVE_GOVERNANCE_V2_EXECUTOR_LONG = _ref8.AAVE_GOVERNANCE_V2_EXECUTOR_LONG;

    if (!utils.isAddress(AAVE_GOVERNANCE_V2) || !utils.isAddress(AAVE_GOVERNANCE_V2_HELPER) || !utils.isAddress(AAVE_GOVERNANCE_V2_EXECUTOR_SHORT) || !utils.isAddress(AAVE_GOVERNANCE_V2_EXECUTOR_LONG)) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (action && gasLimitRecommendations[action] && tx.gasLimit.lte(BigNumber$1.from(gasLimitRecommendations[action].limit))) {
                  tx.gasLimit = BigNumber$1.from(gasLimitRecommendations[action].recommended);
                }
              ...
              switch (_context2.prev = _context2.next) {
                ...
                case 4:
                  ...
                  hasPendingApprovals = txs.find(function (tx) {
                    return tx.txType === eEthereumTxType.ERC20_APPROVAL;
                  });
...
function (_BaseService) {
  ...
  function LiquiditySwapAdapterService(config, swapCollateralConfig) {
    var _this$swapCollateralC;

    var _this;

    _this = _BaseService.call(this, config, IParaSwapLiquiditySwapAdapter__factory) || this;
    _this.swapCollateralConfig = swapCollateralConfig;
    _this.liquiditySwapAdapterAddress = ((_this$swapCollateralC = _this.swapCollateralConfig) == null ? void 0 : _this$swapCollateralC.SWAP_COLLATERAL_ADAPTER) || '';
    return _this;
  }

  var _proto = LiquiditySwapAdapterService.prototype;

  _proto.swapAndDeposit = function swapAndDeposit(_ref, txs) {
    var user = _ref.user,
...
__decorate([LiquiditySwapValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('assetToSwapFrom')), __param(0, IsEthAddress('assetToSwapTo')), __param(0, IsEthAddress('augustus')), __param(0, IsPositiveAmount('amountToSwap')), __param(0, IsPositiveAmount('minAmountToReceive')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Array]), __metadata("design:returntype", Object)], LiquiditySwapAdapterService.prototype, "swapAndDeposit", null);
...
var buildParaSwapLiquiditySwapParams = function buildParaSwapLiquiditySwapParams(assetToSwapTo, minAmountToReceive, swapAllBalanceOffset, swapCalldata, augustus, permitAmount, deadline, v, r, s) {
  return utils.defaultAbiCoder.encode(['address', 'uint256', 'uint256', 'bytes', 'address', 'tuple(uint256,uint256,uint8,bytes32,bytes32)'], [assetToSwapTo, minAmountToReceive, swapAllBalanceOffset, swapCalldata, augustus, [permitAmount, deadline, v, r, s]]);
};
...
function (_BaseService) {
  ...
  function LendingPool(config, erc20Service, synthetixService, wethGatewayService, liquiditySwapAdapterService, repayWithCollateralAdapterService, market, lendingPoolConfig) {
    var _this;
    ...
    _this.market = market;
    _this.lendingPoolConfig = lendingPoolConfig;

    var _ref = _this.lendingPoolConfig || {},
        LENDING_POOL = _ref.LENDING_POOL,
        FLASH_LIQUIDATION_ADAPTER = _ref.FLASH_LIQUIDATION_ADAPTER,
        REPAY_WITH_COLLATERAL_ADAPTER = _ref.REPAY_WITH_COLLATERAL_ADAPTER,
        SWAP_COLLATERAL_ADAPTER = _ref.SWAP_COLLATERAL_ADAPTER;

    _this.lendingPoolAddress = LENDING_POOL || '';
    _this.flashLiquidationAddress = FLASH_LIQUIDATION_ADAPTER || '';
    _this.swapCollateralAddress = SWAP_COLLATERAL_ADAPTER || '';
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee(_ref2) {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              user = _ref2.user, reserve = _ref2.reserve, amount = _ref2.amount, onBehalfOf = _ref2.onBehalfOf, referralCode = _ref2.referralCode;
    ...
    runtime_1.mark(function _callee2(_ref3) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              user = _ref3.user, reserve = _ref3.reserve, amount = _ref3.amount, onBehalfOf = _ref3.onBehalfOf, aTokenAddress = _ref3.aTokenAddress;
            ...
            case 8:
              ...
              convertedAmount = amount === '-1' ? constants.MaxUint256.toString() : parseNumber(amount, decimals);
              lendingPoolContract = this.getContractInstance(this.lendingPoolAddress);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee3(_ref4) {
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              user = _ref4.user, reserve = _ref4.reserve, amount = _ref4.amount, interestRateMode = _ref4.interestRateMode, debtTokenAddress = _ref4.debtTokenAddress, onBehalfOf = _ref4.onBehalfOf, referralCode = _ref4.referralCode;
            ...
            case 8:
              ...
              numericRateMode = interestRateMode === InterestRate.Variable ? 2 : 1;
              lendingPoolContract = this.getContractInstance(this.lendingPoolAddress);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee4(_ref5) {
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              user = _ref5.user, reserve = _ref5.reserve, amount = _ref5.amount, interestRateMode = _ref5.interestRateMode, onBehalfOf = _ref5.onBehalfOf;
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee5(_ref6) {
      var user, reserve, interestRateMode, numericRateMode, lendingPoolContract, txCallback;
      return runtime_1.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              user = _ref6.user, reserve = _ref6.reserve, interestRateMode = _ref6.interestRateMode;
              numericRateMode = interestRateMode === InterestRate.Variable ? 2 : 1;
              lendingPoolContract = this.getContractInstance(this.lendingPoolAddress);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee6(_ref7) {
      var user, reserve, usageAsCollateral, lendingPoolContract, txCallback;
      return runtime_1.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              user = _ref7.user, reserve = _ref7.reserve, usageAsCollateral = _ref7.usageAsCollateral;
              lendingPoolContract = this.getContractInstance(this.lendingPoolAddress);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee7(_ref8) {
      var liquidator, liquidatedUser, debtReserve, collateralReserve, purchaseAmount, getAToken, liquidateAll, txs, _this$erc20Service3, isApproved, approve, getTokenData, approved, approveTx, _ref9, debtReserveInfo, reserveDecimals, convertedAmount, lendingPoolContract, txCallback;

      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              liquidator = _ref8.liquidator, liquidatedUser = _ref8.liquidatedUser, debtReserve = _ref8.debtReserve, collateralReserve = _ref8.collateralReserve, purchaseAmount = _ref8.purchaseAmount, getAToken = _ref8.getAToken, liquidateAll = _ref8.liquidateAll;
              txs = [];
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee8(_ref10) {
      var _this2 = this;

      var user, flash, fromAsset, fromAToken, toAsset, fromAmount, minToAmount, permitSignature, swapAll, onBehalfOf, referralCode, augustus, swapCallData, txs, permitParams, approved, approveTx, tokenDecimals, convertedAmount, tokenToDecimals, amountSlippageConverted, lendingPoolContract, params, amountWithSurplus, convertedAmountWithSurplus, txCallback, swapAndDepositTx;
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              user = _ref10.user, flash = _ref10.flash, fromAsset = _ref10.fromAsset, fromAToken = _ref10.fromAToken, toAsset = _ref10.toAsset, fromAmount = _ref10.fromAmount, minToAmount = _ref10.minToAmount, permitSignature = _ref10.permitSignature, swapAll = _ref10.swapAll, onBehalfOf = _ref10.onBehalfOf, referralCode = _ref10.referralCode, augustus = _ref10.augustus, swapCallData = _ref10.swapCallData;
              txs = [];
              ...
              _context8.next = 5;
              return this.erc20Service.isApproved(fromAToken, user, this.swapCollateralAddress, fromAmount);

            case 5:
              approved = _context8.sent;

              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, this.swapCollateralAddress, constants.MaxUint256.toString());
                txs.push(approveTx);
              }
            ...
            case 13:
              ...
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
                  return lendingPoolContract.populateTransaction.flashLoan(_this2.swapCollateralAddress, [fromAsset], swapAll ? [convertedAmountWithSurplus] : [convertedAmount], [0], // interest rate mode to NONE for flashloan to not open debt
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee9(_ref11) {
      var _this3 = this;

      var user, fromAsset, fromAToken, assetToRepay, repayWithAmount, repayAmount, permitSignature, repayAllDebt, rateMode, onBehalfOf, referralCode, flash, useEthPath, txs, permitParams, approved, approveTx, fromDecimals, convertedRepayWithAmount, repayAmountWithSurplus, decimals, convertedRepayAmount, numericInterestRate, params, lendingPoolContract, txCallback, swapAndRepayTx;
      return runtime_1.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              user = _ref11.user, fromAsset = _ref11.fromAsset, fromAToken = _ref11.fromAToken, assetToRepay = _ref11.assetToRepay, repayWithAmount = _ref11.repayWithAmount, repayAmount = _ref11.repayAmount, permitSignature = _ref11.permitSignature, repayAllDebt = _ref11.repayAllDebt, rateMode = _ref11.rateMode, onBehalfOf = _ref11.onBehalfOf, referralCode = _ref11.referralCode, flash = _ref11.flash, useEthPath = _ref11.useEthPath;
              txs = [];
              permitParams = permitSignature || {
                amount: '0',
                deadline: '0',
              ...
              _context9.next = 5;
              return this.erc20Service.isApproved(fromAToken, user, this.repayWithCollateralAddress, repayWithAmount);

            case 5:
              approved = _context9.sent;

              if (!approved) {
                approveTx = this.erc20Service.approve(user, fromAToken, this.repayWithCollateralAddress, constants.MaxUint256.toString());
                txs.push(approveTx);
              }
            ...
            case 14:
              ...
              params = utils.defaultAbiCoder.encode(['address', 'uint256', 'uint256', 'uint256', 'uint256', 'uint8', 'bytes32', 'bytes32', 'bool'], [fromAsset, convertedRepayWithAmount, numericInterestRate, permitParams.amount, permitParams.deadline, permitParams.v, permitParams.r, permitParams.s, useEthPath || false]);
              lendingPoolContract = this.getContractInstance(this.lendingPoolAddress);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
                  return lendingPoolContract.populateTransaction.flashLoan(_this3.repayWithCollateralAddress, [assetToRepay], [convertedRepayAmount], [0], // interest rate mode to NONE for flashloan to not open debt
                  onBehalfOf || user, params, referralCode || '0');
                },
                from: user
              });
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee10(_ref12) {
      var _this4 = this;

      var user, collateralAsset, borrowedAsset, debtTokenCover, liquidateAll, initiator, useEthPath, addSurplus, txs, lendingPoolContract, tokenDecimals, convertedDebt, convertedDebtTokenCover, flashBorrowAmount, params, txCallback;
      return runtime_1.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              user = _ref12.user, collateralAsset = _ref12.collateralAsset, borrowedAsset = _ref12.borrowedAsset, debtTokenCover = _ref12.debtTokenCover, liquidateAll = _ref12.liquidateAll, initiator = _ref12.initiator, useEthPath = _ref12.useEthPath;
            ...
            case 6:
              ...
              convertedDebtTokenCover = liquidateAll ? constants.MaxUint256.toString() : convertedDebt;
              flashBorrowAmount = liquidateAll ? parseNumber(addSurplus(debtTokenCover), tokenDecimals) : convertedDebt;
              params = utils.defaultAbiCoder.encode(['address', 'address', 'address', 'uint256', 'bool'], [collateralAsset, borrowedAsset, user, convertedDebtTokenCover, useEthPath || false]);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
                  return lendingPoolContract.populateTransaction.flashLoan(_this4.flashLiquidationAddress, [borrowedAsset], [flashBorrowAmount], [0], initiator, params, '0');
                },
                from: initiator
              });
              txs.push({
...
__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __param(0, IsPositiveAmount('amount')), __param(0, IsEthAddress('onBehalfOf')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "deposit", null);

__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __param(0, IsPositiveOrMinusOneAmount('amount')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsEthAddress('aTokenAddress')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "withdraw", null);

__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __param(0, IsPositiveAmount('amount')), __param(0, IsEthAddress('debtTokenAddress')), __param(0, IsEthAddress('onBehalfOf')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "borrow", null);

__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __param(0, IsPositiveOrMinusOneAmount('amount')), __param(0, IsEthAddress('onBehalfOf')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "repay", null);

__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "swapBorrowRateMode", null);

__decorate([LPValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('reserve')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "setUsageAsCollateral", null);

__decorate([LPValidator, __param(0, IsEthAddress('liquidator')), __param(0, IsEthAddress('liquidatedUser')), __param(0, IsEthAddress('debtReserve')), __param(0, IsEthAddress('collateralReserve')), __param(0, IsPositiveAmount('purchaseAmount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "liquidationCall", null);

__decorate([LPSwapCollateralValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('fromAsset')), __param(0, IsEthAddress('fromAToken')), __param(0, IsEthAddress('toAsset')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsEthAddress('augustus')), __param(0, IsPositiveAmount('fromAmount')), __param(0, IsPositiveAmount('minToAmount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "swapCollateral", null);

__decorate([LPRepayWithCollateralValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('fromAsset')), __param(0, IsEthAddress('fromAToken')), __param(0, IsEthAddress('assetToRepay')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsPositiveAmount('repayWithAmount')), __param(0, IsPositiveAmount('repayAmount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "repayWithCollateral", null);

__decorate([LPFlashLiquidationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('collateralAsset')), __param(0, IsEthAddress('borrowedAsset')), __param(0, IsPositiveAmount('debtTokenCover')), __param(0, IsEthAddress('initiator')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], LendingPool.prototype, "flashLiquidation", null);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                amountBNWithDecimals = amount === '-1' ? BigNumber$1.from(SUPER_BIG_ALLOWANCE_NUMBER) : BigNumber$1.from(parseNumber(amount, decimals));
...
function (_BaseService) {
  ...
  function FaucetService(config, faucetConfig) {
    var _this$faucetConfig;

    var _this;

    _this = _BaseService.call(this, config, IMinter__factory) || this;
    _this.faucetConfig = faucetConfig;
    var provider = _this.config.provider;
    _this.faucetAddress = ((_this$faucetConfig = _this.faucetConfig) == null ? void 0 : _this$faucetConfig.FAUCET) || '';

    if (_this.faucetAddress !== '') {
...
__decorate([FaucetValidator, __param(0, IsEthAddress('userAddress')), __param(0, IsEthAddress('reserve')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], FaucetService.prototype, "mint", null);
...
function (_BaseService) {
  ...
  function LTAMigratorService(config, erc20Service, migratorConfig) {
    var _this$migratorConfig;
    ...
    _this.erc20Service = erc20Service;
    _this.migratorConfig = migratorConfig;
    _this.migratorAddress = ((_this$migratorConfig = _this.migratorConfig) == null ? void 0 : _this$migratorConfig.LEND_TO_AAVE_MIGRATOR) || '';
    return _this;
  }
...
__decorate([LTAMigratorValidator, __param(0, IsEthAddress()), __param(1, IsPositiveAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String]), __metadata("design:returntype", Promise)], LTAMigratorService.prototype, "migrateLendToAave", null);
...
function (_BaseService) {
  ...
  function StakingService(config, erc20Service, tokenStake, stakingConfig) {
    var _this;

    _this = _BaseService.call(this, config, IStakedToken__factory) || this;
    _this.stakingConfig = stakingConfig;
    _this.tokenStake = tokenStake;
    _this.erc20Service = erc20Service;
    var provider = _this.config.provider;

    var _ref = _this.stakingConfig || {},
        TOKEN_STAKING = _ref.TOKEN_STAKING,
        STAKING_REWARD_TOKEN = _ref.STAKING_REWARD_TOKEN,
        STAKING_HELPER = _ref.STAKING_HELPER;

    _this.stakingContractAddress = TOKEN_STAKING || '';
    _this.stakingRewardTokenContractAddress = STAKING_REWARD_TOKEN || '';
    _this.stakingHelperContractAddress = STAKING_HELPER;

    if (_this.stakingHelperContractAddress) {
      _this.stakingHelperContract = IAaveStakingHelper__factory.connect(_this.stakingHelperContractAddress, provider);
    }
  ...
  function () {
    ...
    runtime_1.mark(function _callee(user, amount, nonce) {
      var getTokenData, stakingContract, stakedToken, _ref2, name, decimals, convertedAmount, typeData;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              sig = utils.splitSignature(signature);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
...
__decorate([SignStakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "signStaking", null);

__decorate([StakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "stakeWithPermit", null);

__decorate([StakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveAmount()), __param(2, Optional), __param(2, IsEthAddress()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "stake", null);

__decorate([StakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveOrMinusOneAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "redeem", null);

__decorate([StakingValidator, __param(0, IsEthAddress()), __metadata("design:type", Function), __metadata("design:paramtypes", [String]), __metadata("design:returntype", Promise)], StakingService.prototype, "cooldown", null);

__decorate([StakingValidator, __param(0, IsEthAddress()), __param(1, IsPositiveOrMinusOneAmount()), __metadata("design:type", Function), __metadata("design:paramtypes", [String, String]), __metadata("design:returntype", Promise)], StakingService.prototype, "claimRewards", null);
...
function (_BaseService) {
  ...
  function SynthetixService(config) {
      ...
      runtime_1.mark(function _callee(userAddress, reserve, amount) {
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(reserve.toUpperCase() === _this.synthAddress.toUpperCase())) {
                  _context.next = 2;
                  break;
                }
      ...
      runtime_1.mark(function _callee2(userAddress, amount) {
        ...
        return runtime_1.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                synthContract = _this.getContractInstance(_this.synthAddress);
                _context2.next = 3;
                return synthContract.transferableSynthetix(userAddress);

              case 3:
                transferableAmount = _context2.sent;
                return _context2.abrupt("return", BigNumber$1.from(amount).lte(transferableAmount));
    ...
    _this.synthAddress = ((_cosntantAddressesByN = cosntantAddressesByNetwork[network]) == null ? void 0 : _cosntantAddressesByN.SYNTHETIX_PROXY_ADDRESS) || '';
    return _this;
  }
...
function (_BaseService) {
  ...
  function IncentivesController(config, incentivesConfig) {
    var _this;

    _this = _BaseService.call(this, config, IAaveIncentivesController__factory) || this;
    _this.incentivesConfig = incentivesConfig;

    var _ref = _this.incentivesConfig || {},
        INCENTIVES_CONTROLLER = _ref.INCENTIVES_CONTROLLER,
        INCENTIVES_CONTROLLER_REWARD_TOKEN = _ref.INCENTIVES_CONTROLLER_REWARD_TOKEN;

    _this.incentivesControllerAddress = INCENTIVES_CONTROLLER || '';
    _this.incentivesControllerRewardTokenAddress = INCENTIVES_CONTROLLER_REWARD_TOKEN || '';
    return _this;
  }

  var _proto = IncentivesController.prototype;

  _proto.claimRewards = function claimRewards(_ref2) {
    var user = _ref2.user,
        assets = _ref2.assets,
        to = _ref2.to;
    ...
    var txCallback = this.generateTxCallback({
      rawTxMethod: function rawTxMethod() {
        return incentivesContract.populateTransaction.claimRewards(assets, constants.MaxUint256.toString(), to || user);
      },
      from: user
    });
    return [{
...
__decorate([IncentivesValidator, __param(0, IsEthAddress('user')) // @IsEthAddressArray('assets')
, __param(0, IsEthAddress('to')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Array)], IncentivesController.prototype, "claimRewards", null);
...
var BaseTxBuilder = function BaseTxBuilder(network, injectedProvider, defaultProviderKeys, config) {
  var _this = this,
      _this$txBuilderConfig5,
      _this$txBuilderConfig6;
  ...
  this.getFaucet = function (market) {
    if (!_this.faucets[market]) {
      var _this$txBuilderConfig, _this$txBuilderConfig2;

      var _network = _this.configuration.network;
      _this.faucets[market] = new FaucetService(_this.configuration, (_this$txBuilderConfig = _this.txBuilderConfig.lendingPool) == null ? void 0 : (_this$txBuilderConfig2 = _this$txBuilderConfig[_network]) == null ? void 0 : _this$txBuilderConfig2[market]);
    }

    return _this.faucets[market];
  };

  this.getStaking = function (stake) {
    if (!_this.stakings[stake]) {
      var _this$txBuilderConfig3, _this$txBuilderConfig4;

      var _network2 = _this.configuration.network;
      var stakingConfig = (_this$txBuilderConfig3 = _this.txBuilderConfig.staking) == null ? void 0 : (_this$txBuilderConfig4 = _this$txBuilderConfig3[_network2]) == null ? void 0 : _this$txBuilderConfig4[stake];
      _this.stakings[stake] = new StakingService(_this.configuration, _this.erc20Service, stake, stakingConfig);
    }

    return _this.stakings[stake];
  };
  ...
  this.ltaMigratorService = new LTAMigratorService(this.configuration, this.erc20Service, (_this$txBuilderConfig5 = this.txBuilderConfig.migrator) == null ? void 0 : _this$txBuilderConfig5[network]);
  this.incentiveService = new IncentivesController(this.configuration, (_this$txBuilderConfig6 = this.txBuilderConfig.incentives) == null ? void 0 : _this$txBuilderConfig6[network]);
  this.stakings = {};
  this.faucets = {};
};
...
function (_BaseService) {
  ...
  function WETHGatewayService(config, baseDebtTokenService, erc20Service, wethGatewayConfig) {
    var _this$wethGatewayConf;

    var _this;

    _this = _BaseService.call(this, config, IWETHGateway__factory) || this;
    _this.wethGatewayConfig = wethGatewayConfig;
    _this.baseDebtTokenService = baseDebtTokenService;
    _this.erc20Service = erc20Service;
    _this.wethGatewayAddress = ((_this$wethGatewayConf = _this.wethGatewayConfig) == null ? void 0 : _this$wethGatewayConf.WETH_GATEWAY) || '';
    return _this;
  }
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              if (!delegationApproved) {
                approveDelegationTx = this.baseDebtTokenService.approveDelegation(user, this.wethGatewayAddress, debtTokenAddress, constants.MaxUint256.toString());
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              convertedAmount = amount === '-1' ? constants.MaxUint256.toString() : parseNumber(amount, 18);
              _context3.next = 6;
            ...
            case 6:
              ...
              if (!approved) {
                approveTx = approve(user, aTokenAddress, this.wethGatewayAddress, constants.MaxUint256.toString());
                txs.push(approveTx);
              }
...
__decorate([WETHValidator, __param(0, IsEthAddress('lendingPool')), __param(0, IsEthAddress('user')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsPositiveAmount('amount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], WETHGatewayService.prototype, "depositETH", null);

__decorate([WETHValidator, __param(0, IsEthAddress('lendingPool')), __param(0, IsEthAddress('user')), __param(0, IsPositiveAmount('amount')), __param(0, IsEthAddress('debtTokenAddress')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], WETHGatewayService.prototype, "borrowETH", null);

__decorate([WETHValidator, __param(0, IsEthAddress('lendingPool')), __param(0, IsEthAddress('user')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsPositiveOrMinusOneAmount('amount')), __param(0, IsEthAddress('aTokenAddress')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], WETHGatewayService.prototype, "withdrawETH", null);

__decorate([WETHValidator, __param(0, IsEthAddress('lendingPool')), __param(0, IsEthAddress('user')), __param(0, IsEthAddress('onBehalfOf')), __param(0, IsPositiveAmount('amount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], WETHGatewayService.prototype, "repayETH", null);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              amountBNWithDecimals = BigNumber$1.from(parseNumber(amount, decimals));
...
function (_BaseService) {
  ...
  function RepayWithCollateralAdapterService(config, repayWithCollateralConfig) {
    var _this$repayWithCollat;

    var _this;

    _this = _BaseService.call(this, config, IRepayWithCollateral__factory) || this;
    _this.repayWithCollateralConfig = repayWithCollateralConfig;
    _this.repayWithCollateralAddress = ((_this$repayWithCollat = _this.repayWithCollateralConfig) == null ? void 0 : _this$repayWithCollat.REPAY_WITH_COLLATERAL_ADAPTER) || '';
    return _this;
  }

  var _proto = RepayWithCollateralAdapterService.prototype;

  _proto.swapAndRepay = function swapAndRepay(_ref, txs) {
    var user = _ref.user,
...
__decorate([RepayWithCollateralValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('collateralAsset')), __param(0, IsEthAddress('debtAsset')), __param(0, IsPositiveAmount('collateralAmount')), __param(0, IsPositiveAmount('debtRepayAmount')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Array]), __metadata("design:returntype", Object)], RepayWithCollateralAdapterService.prototype, "swapAndRepay", null);
...
function (_BaseService) {
  ...
  function AaveGovernanceV2Service(config, governanceConfig) {
    var _this;

    _this = _BaseService.call(this, config, IAaveGovernanceV2__factory) || this;
    _this.executors = [];
    _this.governanceConfig = governanceConfig;

    var _ref2 = _this.governanceConfig || {},
        AAVE_GOVERNANCE_V2 = _ref2.AAVE_GOVERNANCE_V2,
        AAVE_GOVERNANCE_V2_HELPER = _ref2.AAVE_GOVERNANCE_V2_HELPER,
        AAVE_GOVERNANCE_V2_EXECUTOR_SHORT = _ref2.AAVE_GOVERNANCE_V2_EXECUTOR_SHORT,
        AAVE_GOVERNANCE_V2_EXECUTOR_LONG = _ref2.AAVE_GOVERNANCE_V2_EXECUTOR_LONG;

    _this.aaveGovernanceV2Address = AAVE_GOVERNANCE_V2 || '';
    _this.aaveGovernanceV2HelperAddress = AAVE_GOVERNANCE_V2_HELPER || '';
    _this.executors[ExecutorType.Short] = AAVE_GOVERNANCE_V2_EXECUTOR_SHORT || '';
    _this.executors[ExecutorType.Long] = AAVE_GOVERNANCE_V2_EXECUTOR_LONG || '';
    return _this;
  }
    ...
    runtime_1.mark(function _callee2(_ref3) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              user = _ref3.user, targets = _ref3.targets, values = _ref3.values, signatures = _ref3.signatures, calldatas = _ref3.calldatas, withDelegateCalls = _ref3.withDelegateCalls, ipfsHash = _ref3.ipfsHash, executor = _ref3.executor;
              txs = [];
    ...
    runtime_1.mark(function _callee5(_ref6) {
      ...
      return runtime_1.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              user = _ref6.user, proposalId = _ref6.proposalId;
              txs = [];
              govContract = this.getContractInstance(this.aaveGovernanceV2Address);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
    ...
    runtime_1.mark(function _callee6(_ref7) {
      ...
      return runtime_1.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              user = _ref7.user, proposalId = _ref7.proposalId, support = _ref7.support;
              txs = [];
              govContract = this.getContractInstance(this.aaveGovernanceV2Address);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
    ...
    runtime_1.mark(function _callee7(_ref8) {
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              support = _ref8.support, proposalId = _ref8.proposalId;
              typeData = {
                types: {
                  EIP712Domain: [{
                    name: 'name',
    ...
    runtime_1.mark(function _callee8(_ref9) {
      ...
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              user = _ref9.user, proposalId = _ref9.proposalId, support = _ref9.support, signature = _ref9.signature;
              txs = [];
              govContract = this.getContractInstance(this.aaveGovernanceV2Address);
              sig = utils.splitSignature(signature);
              txCallback = this.generateTxCallback({
    ...
    runtime_1.mark(function _callee10(_ref10) {
      ...
      return runtime_1.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              skip = _ref10.skip, limit = _ref10.limit;
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee11(_ref12) {
      var proposalId, provider, helper, proposal;
      return runtime_1.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              proposalId = _ref12.proposalId;
              provider = this.config.provider;
              helper = IGovernanceV2Helper__factory.connect(this.aaveGovernanceV2HelperAddress, provider);
              _context11.next = 5;
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee12(_ref13) {
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 5:
              ...
              return _context12.abrupt("return", formatEther(power));
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee13(_ref14) {
      var user, block, strategy, provider, proposalStrategy, power;
      return runtime_1.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              user = _ref14.user, block = _ref14.block, strategy = _ref14.strategy;
              provider = this.config.provider;
              proposalStrategy = IGovernanceStrategy__factory.connect(strategy, provider);
              _context13.next = 5;
            ...
            case 5:
              ...
              return _context13.abrupt("return", formatEther(power));
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee14(_ref15) {
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 5:
              ...
              return _context14.abrupt("return", formatEther(total));
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee15(_ref16) {
      var block, strategy, provider, proposalStrategy, total;
      return runtime_1.wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              block = _ref16.block, strategy = _ref16.strategy;
              provider = this.config.provider;
              proposalStrategy = IGovernanceStrategy__factory.connect(strategy, provider);
              _context15.next = 5;
            ...
            case 5:
              ...
              return _context15.abrupt("return", formatEther(total));
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee16(_ref17) {
  ...
  function () {
    ...
    _asyncToGenerator(
    /*#__PURE__*/
    runtime_1.mark(function _callee17(_ref18) {
      var proposalId, user, govContract;
      return runtime_1.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              proposalId = _ref18.proposalId, user = _ref18.user;
              govContract = this.getContractInstance(this.aaveGovernanceV2Address);
...
__decorate([GovValidator, __param(0, IsEthAddress('user')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "create", null);

__decorate([GovValidator, __param(0, IsEthAddress('user')), __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "cancel", null);

__decorate([GovValidator, __param(0, IsEthAddress('user')), __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "queue", null);

__decorate([GovValidator, __param(0, IsEthAddress('user')), __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "execute", null);

__decorate([GovValidator, __param(0, IsEthAddress('user')), __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "submitVote", null);

__decorate([GovValidator, __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "signVoting", null);

__decorate([GovValidator, __param(0, IsEthAddress('user')), __param(0, Is0OrPositiveAmount('proposalId')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "submitVoteBySignature", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getProposals", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getProposal", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getPropositionPowerAt", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getVotingPowerAt", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getTotalPropositionSupplyAt", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getTotalVotingSupplyAt", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getTokensPower", null);

__decorate([GovValidator, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AaveGovernanceV2Service.prototype, "getVoteOnProposal", null);
...
__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "delegate", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "delegateByType", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "delegateBySig", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "delegateByTypeBySig", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __param(0, Is0OrPositiveAmount('nonce')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "prepareDelegateSignature", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddressOrENS('delegatee')), __param(0, IsEthAddress('governanceToken')), __param(0, Is0OrPositiveAmount('nonce')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "prepareDelegateByTypeSignature", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('delegator')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "getDelegateeByType", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "getPowerCurrent", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('governanceToken')), __param(0, IsPositiveAmount('blockNumber')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "getPowerAtBlock", null);

__decorate([GovDelegationValidator, __param(0, IsEthAddress('user')), __param(0, IsEthAddress('governanceToken')), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], GovernanceDelegationTokenService.prototype, "getNonce", null);
...
function (_BaseTxBuilder) {
  ...
  function TxBuilder(network, injectedProvider, defaultProviderKeys, config) {
    var _this$txBuilderConfig9;
    ...
    _this = _BaseTxBuilder.call(this, network, injectedProvider, defaultProviderKeys, config) || this;

    _this.getRepayWithCollateralAdapter = function (market) {
      var network = _this.configuration.network;

      if (!_this.repayWithCollateralAdapters[market]) {
        var _this$txBuilderConfig, _this$txBuilderConfig2;

        _this.repayWithCollateralAdapters[market] = new RepayWithCollateralAdapterService(_this.configuration, (_this$txBuilderConfig = _this.txBuilderConfig.lendingPool) == null ? void 0 : (_this$txBuilderConfig2 = _this$txBuilderConfig[network]) == null ? void 0 : _this$txBuilderConfig2[market]);
      }

      return _this.repayWithCollateralAdapters[market];
    };

    _this.getSwapCollateralAdapter = function (market) {
      var network = _this.configuration.network;

      if (!_this.swapCollateralAdapters[market]) {
        var _this$txBuilderConfig3, _this$txBuilderConfig4;

        _this.swapCollateralAdapters[market] = new LiquiditySwapAdapterService(_this.configuration, (_this$txBuilderConfig3 = _this.txBuilderConfig.lendingPool) == null ? void 0 : (_this$txBuilderConfig4 = _this$txBuilderConfig3[network]) == null ? void 0 : _this$txBuilderConfig4[market]);
      }

      return _this.swapCollateralAdapters[market];
    };

    _this.getWethGateway = function (market) {
      var network = _this.configuration.network;

      if (!_this.wethGateways[market]) {
        var _this$txBuilderConfig5, _this$txBuilderConfig6;

        _this.wethGateways[market] = new WETHGatewayService(_this.configuration, _this.baseDebtTokenService, _this.erc20Service, (_this$txBuilderConfig5 = _this.txBuilderConfig.lendingPool) == null ? void 0 : (_this$txBuilderConfig6 = _this$txBuilderConfig5[network]) == null ? void 0 : _this$txBuilderConfig6[market]);
      }

      return _this.wethGateways[market];
    };
    ...
    _this.getLendingPool = function (market) {
      ...
      if (!_this.lendingPools[market]) {
        var _this$txBuilderConfig7, _this$txBuilderConfig8;

        _this.lendingPools[market] = new LendingPool(_this.configuration, _this.erc20Service, _this.synthetixService, _this.getWethGateway(market), _this.getSwapCollateralAdapter(market), _this.getRepayWithCollateralAdapter(market), market, (_this$txBuilderConfig7 = _this.txBuilderConfig.lendingPool) == null ? void 0 : (_this$txBuilderConfig8 = _this$txBuilderConfig7[network]) == null ? void 0 : _this$txBuilderConfig8[market]);
      }
    ...
    _this.wethGateways = {};
    _this.lendingPools = {};
    _this.swapCollateralAdapters = {};
    _this.repayWithCollateralAdapters = {};
    _this.baseDebtTokenService = new BaseDebtToken(_this.configuration, _this.erc20Service);
    _this.aaveGovernanceV2Service = new AaveGovernanceV2Service(_this.configuration, (_this$txBuilderConfig9 = _this.txBuilderConfig.governance) == null ? void 0 : _this$txBuilderConfig9[network]);
...
export { API_ETH_MOCK_ADDRESS, BigNumberZD, ChainId, DEFAULT_APPROVE_AMOUNT, DEFAULT_NULL_VALUE_ON_TX, ETH_DECIMALS, ExecutorType, GovernanceVote, HALF_RAY, HALF_WAD, InterestRate, LTV_PRECISION, MAX_UINT_AMOUNT, Market, Network, ProposalState, ProtocolAction, RAY, RAY_DECIMALS, SECONDS_PER_YEAR, SUPER_BIG_ALLOWANCE_NUMBER, SURPLUS, Stake, TxBuilder as TxBuilderV2, USD_DECIMALS, WAD, WAD_RAY_RATIO, binomialApproximatedRayPow, calculateAvailableBorrowsETH, calculateAverageRate, calculateCompoundedInterest, calculateHealthFactorFromBalances, calculateHealthFactorFromBalancesBigUnits, calculateIncentivesAPY, calculateLinearInterest, calculateReserveDebt, calculateReserveDebtSuppliesRaw, calculateRewards, calculateSupplies, computeRawUserSummaryData$1 as computeRawUserSummaryData, computeUserReserveData$1 as computeUserReserveData, cosntantAddressesByNetwork, eEthereumTxType, formatReserves$1 as formatReserves, formatUserSummaryData$1 as formatUserSummaryData, gasLimitRecommendations, getCompoundedBalance, getCompoundedStableBalance, getEthAndUsdBalance, getLinearBalance, getReserveNormalizedIncome, normalize, normalizeBN, pow10, rayDiv, rayMul, rayPow, rayToDecimal, rayToWad, uniswapEthAmount, index as v1, index$1 as v2, valueToBigNumber, valueToZDBigNumber, wadDiv, wadMul, wadToRay };
//# sourceMappingURL=protocol-js.esm.js.map
